...
| **Build command**  | Override the auto-detected build command for automatic builds (for example `pnpm build --filter api`). Ignored when a Dockerfile is configured. | Automatic       |
