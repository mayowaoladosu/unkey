...
<Note>
  The dashboard does not yet support creating or managing multiple apps within a project. You can deploy to a specific app using the CLI, or script the full app lifecycle — create, list, get, update, and delete — with the [HTTP API](/api-reference/overview). Contact [support@unkey.com](mailto:support@unkey.com) if you need multi-app projects configured.
</Note>
