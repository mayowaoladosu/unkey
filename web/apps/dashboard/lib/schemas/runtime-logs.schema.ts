...
export const runtimeLogsRequestSchema = z.object({
	...
	resourceId: z.array(z.string()).optional().default([]),
	resourceKind: z.array(z.string()).optional().default([]),
	environmentId: z
		.object({
			filters: z.array(
				z.object({
...
export type RuntimeLogsResponseSchema = z.infer<
	typeof runtimeLogsResponseSchema
>;
