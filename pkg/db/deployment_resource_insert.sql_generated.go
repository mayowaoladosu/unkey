...
//	)
//	ON DUPLICATE KEY UPDATE id = id
func (q *Queries) InsertDeploymentResource(ctx context.Context, db DBTX, arg InsertDeploymentResourceParams) error {
	_, err := db.ExecContext(ctx, insertDeploymentResource,
		arg.ID,
		arg.DeploymentID,
		arg.WorkspaceID,
		arg.ProjectID,
