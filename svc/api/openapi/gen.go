...
const (
	...
	DeploymentTriggerCli       DeploymentTrigger = "cli"
	DeploymentTriggerDashboard DeploymentTrigger = "dashboard"
	DeploymentTriggerGithub    DeploymentTrigger = "github"
	DeploymentTriggerUnkey     DeploymentTrigger = "unkey"
	DeploymentTriggerUnknown   DeploymentTrigger = "unknown"
)
...
type Deployment struct {
	// AppId The unique identifier of the app this deployment belongs to.
	...
	// DesiredState The state the deployment is meant to be in. running means it should be
	// serving; stopped means it has been scaled down.
	DesiredState DeploymentDesiredState `json:"desiredState"`

	// EnvironmentId The unique identifier of the environment this deployment targets.
	EnvironmentId string `json:"environmentId"`

	// ForkRepository Fork the deployment was built from, as "owner/repo", if any.
	ForkRepository string `json:"forkRepository,omitempty"`

	// GitBranch Git branch this deployment was built from.
	// Omitted for prebuilt-image deployments.
	GitBranch string `json:"gitBranch,omitempty"`

	// GitCommitAuthorAvatarUrl Avatar URL of the commit author.
	// Omitted for prebuilt-image deployments.
	GitCommitAuthorAvatarUrl string `json:"gitCommitAuthorAvatarUrl,omitempty"`

	// GitCommitAuthorHandle Git handle of the commit author.
	// Omitted for prebuilt-image deployments.
	GitCommitAuthorHandle string `json:"gitCommitAuthorHandle,omitempty"`

	// GitCommitMessage Message of the git commit this deployment was built from.
	// Omitted for prebuilt-image deployments.
	GitCommitMessage string `json:"gitCommitMessage,omitempty"`

	// GitCommitSha Full SHA of the git commit this deployment was built from.
	// Omitted for prebuilt-image deployments.
	GitCommitSha string `json:"gitCommitSha,omitempty"`

	// GitCommitTimestamp Unix timestamp in milliseconds of the git commit.
	// Omitted for prebuilt-image deployments.
	GitCommitTimestamp int64                   `json:"gitCommitTimestamp,omitempty"`
	...
	// Image Container image reference this deployment runs.
	// Omitted until the image has been resolved.
	...
	// PrNumber Pull request number this deployment was triggered by, if any.
	PrNumber int64 `json:"prNumber,omitempty"`

	// ProjectId The unique identifier of the project this deployment belongs to.
	...
	// TriggerReason Human-readable reason the deployment was triggered, if any.
	TriggerReason string `json:"triggerReason,omitempty"`

	// TriggeredBy Identifier of the actor that triggered this deployment.
...
// DeploymentDesiredState The state the deployment is meant to be in. running means it should be
// serving; stopped means it has been scaled down.
