...
type Policy struct {
	...
	// Id Server-generated policy id. Omit when creating a policy; pass the id of
...
// V2PoliciesSetPoliciesRequestBody defines model for V2PoliciesSetPoliciesRequestBody.
type V2PoliciesSetPoliciesRequestBody struct {
	// App Identifies a resource by either its unique ID or its slug.
	// Accepts a prefixed ID (such as 'proj_' or 'app_') or a slug.
	App ResourceIdentifier `json:"app"`
	...
	// Policies Policies to apply, in evaluation order among themselves. An item
	...
	// Prune Optional. Defaults to false. When false, policies with an `id` are
...
// V2PoliciesSetPoliciesResponseBody defines model for V2PoliciesSetPoliciesResponseBody.
type V2PoliciesSetPoliciesResponseBody struct {
	// Data Empty response object by design. A successful response indicates this operation was successfully executed.
	Data EmptyResponse `json:"data"`
...
// PoliciesSetPoliciesJSONRequestBody defines body for PoliciesSetPolicies for application/json ContentType.
type PoliciesSetPoliciesJSONRequestBody = V2PoliciesSetPoliciesRequestBody
