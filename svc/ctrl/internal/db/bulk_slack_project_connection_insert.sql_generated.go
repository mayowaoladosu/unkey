...
func (q *BulkQueries) InsertSlackProjectConnections(ctx context.Context, args []InsertSlackProjectConnectionParams) error {
	...
	bulkQuery := fmt.Sprintf(bulkInsertSlackProjectConnection, strings.Join(valueClauses, ", "))
