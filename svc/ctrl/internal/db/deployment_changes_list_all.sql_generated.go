...
//	ORDER BY pk ASC
//	LIMIT ?
func (q *Queries) ListDeploymentChangesByRegionAll(ctx context.Context, arg ListDeploymentChangesByRegionAllParams) ([]DeploymentChange, error) {
	rows, err := q.db.QueryContext(ctx, listDeploymentChangesByRegionAll, arg.AfterVersion, arg.RegionID, arg.Limit)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
