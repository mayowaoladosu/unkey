...
type Querier interface {
	...
	DeleteDeploymentTargetAssignmentsByEnvironment(ctx context.Context, environmentID string) error
	//DeleteDeploymentTargetsByEnvironment
	//
	//  DELETE FROM deployment_targets WHERE environment_id = ?
	DeleteDeploymentTargetsByEnvironment(ctx context.Context, environmentID string) error
	...
	FindDeploymentTargetByID(ctx context.Context, id string) (DeploymentTarget, error)
	...
	//    AND kind = ?
	//    AND target_key = ?
	FindDeploymentTargetByIdentity(ctx context.Context, arg FindDeploymentTargetByIdentityParams) (DeploymentTarget, error)
	...
	//  )
	//  ON DUPLICATE KEY UPDATE id = id
	InsertDeploymentTarget(ctx context.Context, arg InsertDeploymentTargetParams) error
	...
	ListDeploymentTargetAssignmentsByEnvironment(ctx context.Context, environmentID string) ([]DeploymentTargetAssignment, error)
	...
	//  WHERE target_id = ?
	//  ORDER BY created_at DESC, pk DESC
	ListDeploymentTargetAssignmentsByTarget(ctx context.Context, targetID string) ([]DeploymentTargetAssignment, error)
	...
	ListDeploymentTargetsByEnvironment(ctx context.Context, environmentID string) ([]DeploymentTarget, error)
	...
	ListDeploymentsForPullRequest(ctx context.Context, arg ListDeploymentsForPullRequestParams) ([]Deployment, error)
	...
	//  )
	//  ON DUPLICATE KEY UPDATE id = id
	RecordDeploymentTargetAssignment(ctx context.Context, arg RecordDeploymentTargetAssignmentParams) error
