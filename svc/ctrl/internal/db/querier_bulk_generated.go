...
type BulkQuerier interface {
	...
	RecordDeploymentArtifact(ctx context.Context, args []RecordDeploymentArtifactParams) error
	...
	InsertDeploymentResources(ctx context.Context, args []InsertDeploymentResourceParams) error
