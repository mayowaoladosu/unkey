...
//	  AND dt.region_id = ?
//	LIMIT 1
func (q *Queries) FindDeploymentResourceTopology(ctx context.Context, arg FindDeploymentResourceTopologyParams) (FindDeploymentResourceTopologyRow, error) {
	row := q.db.QueryRowContext(ctx, findDeploymentResourceTopology, arg.DeploymentID, arg.ResourceID, arg.RegionID)
...
//	ORDER BY dt.pk ASC
//	LIMIT ?
func (q *Queries) ListDeploymentResourceTopologiesByRegion(ctx context.Context, arg ListDeploymentResourceTopologiesByRegionParams) ([]ListDeploymentResourceTopologiesByRegionRow, error) {
	rows, err := q.db.QueryContext(ctx, listDeploymentResourceTopologiesByRegion, arg.RegionID, arg.AfterPk, arg.Limit)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
